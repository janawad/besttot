	...
	<div class="modal fade" id="add-announcement-successModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="data-added-success text-center"><i class="fa fa-check-circle"></i> &nbsp;announcement Added Successfully</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="Update-announcement-successModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="data-added-success text-center"><i class="fa fa-check-circle"></i> &nbsp;announcement Updated Successfully</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="Deleted-announcement-successModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="data-added-success text-center"><i class="fa fa-check-circle"></i> &nbsp;announcement Deleted Successfully</div>
			</div>
		</div>
	</div>
			 ...
			 $result = $announcement->Addannouncement($_REQUEST);
				if($result==1){ ?>
					<script>
						...
						setTimeout(function(){ window.location.href='index.php?page=announcement/list-announcement'  }, 1000);
					</script> <?php
				}
			}else{
			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<!-----Add new blogs---------->
							<a href='index.php?page=announcement/add-announcement' class="btn btn-primary">Add New Announcement</a></br></br>
						<!--------new blogs --------->
					</div>
					<!-- /.box-header -->
					<div class="box-body">
							...
							<tbody>
								<?php foreach($announcement_arr as $announcement){ ?>
									<tr>
										...
										<td>
											<a href="index.php?page=announcement/edit-announcement&announcement_id=<?php echo $announcement['id']; ?>" class="btn bg-green mbottom20">edit</a>
										</td>
										<td>
