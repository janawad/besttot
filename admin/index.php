...
<!-------------------------------------------------------------------------->	
		...
		<title>Best Tutorials | Admin-Panel</title>
		...
		<div class="wrapper">
			...
			<header class="main-header">
				...
				<a href="index.php" class="logo">
				  ...
				  <span class="logo-lg"><b>Best Tutorials</b></span>
				</a>
			...
			<aside class="main-sidebar">
				...
				<section class="sidebar">
					...
					<ul class="sidebar-menu">
						...
						<li class="<?php echo $staff_details ?>">
							<a href="index.php?page=staff_details/list-staff_details">
								<i class="fa fa-book"></i>&nbsp; <span>Staff Details</span>
							</a>
						</li>
						
						<li class="<?php echo $announcement ?>">
							<a href="index.php?page=announcement/list-announcement">
								<i class="fa fa-pie-chart"></i>&nbsp; <span>Announcements</span>
							</a>
						</li>
						...
						<li class="<?php echo $newsletter ?>">
							<a href="index.php?page=newsletter/list-newsletter">
								<i class="fa fa-edit"></i>&nbsp; <span>Newsletter</span>
							</a>
						</li>
			...
			<footer class="main-footer">
				...
				<!-- Default to the left -->
				<strong>Copyright &copy; <script> document.write(new Date().getFullYear());</script> <a href="#" target="__blank">Best Tutorials</a>.</strong> All rights reserved.
			</footer>
		</div>
		<!-- ./wrapper -->
